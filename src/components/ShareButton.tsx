        ...
        <div className="relative">
            ...
            {showMenu && (
                <>
                    ...
                    />
                    <div className="surface absolute right-0 top-full z-50 mt-2 w-52 overflow-hidden rounded-lg p-1 shadow-panel">
                        <button
                            onClick={() => { handleCopy(); setShowMenu(false); }}
                            className="flex w-full items-center gap-3 rounded-md px-3 py-2.5 text-sm text-white/70 transition-colors hover:bg-white/5 hover:text-white"
                        >
                        ...
                        <button
                            ...
                            className="flex w-full items-center gap-3 rounded-md px-3 py-2.5 text-sm text-white/70 transition-colors hover:bg-white/5 hover:text-white"
                        >
                            <svg className="h-4 w-4 text-gold-300" viewBox="0 0 24 24" fill="currentColor">
